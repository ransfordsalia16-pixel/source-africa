...
export default function SupplierDisputes() {
  ...
  return (
    <>
      <PageHeader title="Disputes" subtitle="Respond to reports on your orders with evidence for SourceBridge to review." />
      <div className="panel-grid-2">
        <Panel title="Disputes on your orders">
          {disputes.length === 0 && <div className="empty-state">No disputes right now.</div>}
          {disputes.map((d) => (
